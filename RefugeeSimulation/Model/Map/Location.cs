...
// Extract names of administrative levels
    ...
    public void GetRandomAgentsAtNode(GeoHashEnvironment<MigrantAgent> environment)
    {
        ...
        if (refsAtNode.Length > 1)
        {
            ...
            ref1.FormFriendshipWith(ref2);
        }
    }

    public void UpdateNormMigPop(int maxMigPop)
    {
        // ReSharper disable once InconsistentlySynchronizedField
        
            NormMigPop = MigPop * 1.0 / (maxMigPop * 1.0);
